...
{
    public class SchoolContexto : DbContext
    {
        public SchoolContexto(DbContextOptions<SchoolContexto> dbContextOptions) : base(dbContextOptions) { }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            .HasKey(h => new { h.AlunoId, h.DisciplinaId });

            builder.Entity<AlunoCurso>()
            .HasKey(h => new { h.AlunoId, h.CursoId});

            builder.Entity<Professor>()
                .HasData(new List<Professor>()
                {
                    new Professor(1, 1, "Lauro", "Oliveria"),
